  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application: A world of convenience at your fingertips, making your travel seamless and environment-friendly, one ride at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application: A world of convenience at your fingertips, making your travel seamless and environment-friendly, one ride at a time.`}
            </Text>
            <Box
